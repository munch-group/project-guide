...
Your files on the cluster are not backed up! If you want to backup files, you need to put them in a folder called BACKUP. But even if you do, you may loose a week of work, because the backup loop is slow. 
:::

The best way to keep your progress safe, is to ensure is reproducible and pushed to GitHub. More about that in @sec-reproducible-work and @sec-git.
